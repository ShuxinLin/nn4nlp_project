...
As mentioned, the decoder will take encoder's output Z, and then try to decode each token $\tilde{y_t}$ corresponding to $x_t$. It models the conditional probability: 
  \begin{equation}
