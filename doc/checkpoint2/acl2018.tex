...
% The encoder models the probability $P(Z|X)$, in which $Z$ is the latent variable. But there is an inherent major problem specific to text domain is that the dimensionality of $X$ is usually too high to model efficiently. The popular solution is to learn an non-linear embedding space $E_X$ that shares the similarity of word relation with $X$, but in much smaller dimension. Such popular solution is referred to as word embedding. 
% % such as using word2vec \cite{mikolov2013distributed} or GLoVe \cite{pennington2014glove}. 
...
\begin{tabular}{cc}
\end{tabular}
% \begin{subfigure}{0.4\textwidth}\centering\includegraphics[width=0.7\columnwidth]{fig_lrn_0p001_loss.pdf}\caption{Greedy Search Decoding Loss}\label{fig:taba}\end{subfigure} %\&
...
%%%%%%%%%
% \begin{subfigure}{0.4\textwidth}\centering\includegraphics[width=0.7\columnwidth]{fig_lrn_0p001_beam_10_loss.pdf}\caption{Beam Search Decoding Loss}\label{fig:tabe}\end{subfigure} %\&
...
\captionof{figure}[]{The F-scores of greedy and beam search decoding \textbf{without} attention. Red curve is training set, green curve is validation set, and blue curve is test set. Learning rate is 0.001. For beam search, the beam size used in (b) is 3, and the beam size in (c) is 10.}
...
% \begin{tabular}{cc}
% \end{tabular}
% \begin{subfigure}{0.4\textwidth}\centering\includegraphics[width=0.7\columnwidth]{fig_lrn_0p001_atten_loss.pdf}\caption{Greedy Search Decoding Loss}\label{fig:taba}\end{subfigure} %\&
% \begin{subfigure}{0.4\textwidth}\centering\includegraphics[width=0.7\columnwidth]{fig_lrn_0p001_atten_f.pdf}\caption{Greedy Search Decoding F-Score}\label{fig:tabc}\end{subfigure} \\
...
% \captionof{figure}[]{F-scores of greedy search decoding \textbf{with attention}. Red curve is training set, and blue curve is validation set. Learning rate is 0.001. }
...
%Our greedy search          & 96.60            & 3.14     & 3.14              \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% results 
\section{Directions for Future Work} \label{sec:discussion}% of baseline 
