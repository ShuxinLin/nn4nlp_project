...
def prepocess(data_path, train, val, batch_size, save_file=True):
  train_preprocessor = Preprocessor(data_path, train)
  train_preprocessor.read_file()
  train_preprocessor.preprocess(save_file=save_file)

  val_preprocessor = Preprocessor(data_path, val)
  val_preprocessor.read_file()
  val_preprocessor.preprocess(save_file=save_file)
  ...
  train_preprocessor.index_preprocess(save_file=save_file)
  train_X, train_Y = train_preprocessor.minibatch(batch_size)
  val_preprocessor.index_preprocess(save_file=save_file)
...
def main():
  ...
  train_X, train_Y, val_X, val_Y, vocab_size, label_size, entity_dict = prepocess(data_path, train_file, val_file, batch_size, save_file=save_file)
