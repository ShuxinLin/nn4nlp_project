...
logfile = open("../gitignore/result_lrn_0p001_beam_3/log.txt", "r")
...
plt.savefig('../gitignore/result_lrn_0p001_beam_3/fig_lrn_0p001_beam_3_loss.pdf')
...
plt.xlabel('Epoch')
plt.ylabel('F-score')
plt.savefig('../gitignore/result_lrn_0p001_beam_3/fig_lrn_0p001_beam_3_f.pdf')
