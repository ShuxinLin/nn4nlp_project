...
def main():
  ...
  experience_file_train = os.path.join(result_path, "beam_3_adapt_ckpt_46_episode_train.txt")
  experience_file_val = os.path.join(result_path, "beam_3_adapt_ckpt_46_episode_val.txt")
