...
def main():
    ...
    train_X, train_Y = prepocess(train_file)
    ...
    machine = ner(word_embedding_dim, hidden_dim, label_embedding_dim, len(word_to_idx), len(label_to_idx),
                  learning_rate=0.1, minibatch_size=2, max_epoch=300, train_X=train_X, train_Y=train_Y, test_X=train_X,
                  test_Y=train_Y)
