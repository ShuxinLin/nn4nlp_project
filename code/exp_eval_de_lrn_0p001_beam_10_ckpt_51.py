...
def main():
  ...
  val_fscore = machine.evaluate(val_X, val_Y, index2word, index2label, "val", None, "beam", beam_size, max_beam_size, agent)

  time_begin = time.time()
  test_fscore = machine.evaluate(test_X, test_Y, index2word, index2label, "test", None, "beam", beam_size, max_beam_size, agent)
  time_end = time.time()
