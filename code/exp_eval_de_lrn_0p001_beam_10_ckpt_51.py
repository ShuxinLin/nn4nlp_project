...
def main():
  ...
  eval_output_file = open(os.path.join(result_path, "eval_beam_10_ckpt_51.txt"), "w+")
  ...
  val_fscore = machine.evaluate(val_X, val_Y, index2word, index2label, "val", None, "beam", beam_size, max_beam_size, agent, f_score_index_begin)

  time_begin = time.time()
  test_fscore = machine.evaluate(test_X, test_Y, index2word, index2label, "test", None, "beam", beam_size, max_beam_size, agent, f_score_index_begin)
  time_end = time.time()
