...
def main():
  ...
  eval_output_file = open(os.path.join(result_path, "eval_greedy_ckpt_46.txt"), "w+")
  ...
  val_fscore, val_beam_number, val_avg_beam_size = machine.evaluate(val_X, val_Y, index2word, index2label, "val", None, "greedy", initial_beam_size, max_beam_size, agent, reward_coef_fscore, reward_coef_beam_size, f_score_index_begin)

  time_begin = time.time()
  test_fscore, test_beam_number, test_avg_beam_size = machine.evaluate(test_X, test_Y, index2word, index2label, "test", None, "greedy", initial_beam_size, max_beam_size, agent, reward_coef_fscore, reward_coef_beam_size, f_score_index_begin)
  time_end = time.time()
