...
def main():
  ...
  eval_output_file = open(os.path.join(result_path, "eval_greedy_ckpt_51.txt"), "w+")
  ...
  val_fscore = machine.evaluate(val_X, val_Y, index2word, index2label, "val", None, "greedy", initial_beam_size, max_beam_size, agent)

  time_begin = time.time()
  test_fscore = machine.evaluate(test_X, test_Y, index2word, index2label, "test", None, "greedy", initial_beam_size, max_beam_size, agent)
  time_end = time.time()
