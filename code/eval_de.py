...
def main():
  ...
  for epoch in range(0, max_epoch):
    ...
    val_fscore_beam_adapt = machine.evaluate(val_X, val_Y, index2word, index2label, "val", None, "adaptive", initial_beam_size, max_beam_size, agent)

    time_begin_beam_adapt = time.time()
