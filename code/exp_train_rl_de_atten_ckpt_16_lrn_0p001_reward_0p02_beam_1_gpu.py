...
def main():
  ...
  load_model_filename = os.path.join(load_model_dir, "ckpt_16.pth")
  ...
  parser.add_argument('--logdir', default='../result_atten_ckpt_16_rl_lrn_0p001_reward_0p02_beam_1_gpu',
